...
const (
	...
	CategoryService_CreateBidirectionalCategoryStream_FullMethodName = "/pb.CategoryService/CreateBidirectionalCategoryStream"
...
type CategoryServiceClient interface {
	...
	CreateBidirectionalCategoryStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryRequest, Category], error)
...
func (c *categoryServiceClient) CreateBidirectionalCategoryStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryRequest, Category], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], CategoryService_CreateBidirectionalCategoryStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateBidirectionalCategoryStreamClient = grpc.BidiStreamingClient[CreateCategoryRequest, Category]
...
type CategoryServiceServer interface {
	...
	CreateBidirectionalCategoryStream(grpc.BidiStreamingServer[CreateCategoryRequest, Category]) error
...
func (UnimplementedCategoryServiceServer) CreateBidirectionalCategoryStream(grpc.BidiStreamingServer[CreateCategoryRequest, Category]) error {
...
func _CategoryService_CreateBidirectionalCategoryStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateBidirectionalCategoryStream(&grpc.GenericServerStream[CreateCategoryRequest, Category]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateBidirectionalCategoryStreamServer = grpc.BidiStreamingServer[CreateCategoryRequest, Category]
